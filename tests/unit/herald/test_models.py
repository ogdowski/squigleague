...
class TestCreateExchangeRequest:
    ...
    def test_valid_request__strips_whitespace(self):
        ...
        request = CreateExchangeRequest(list_content="  Test Army List  \n\n")
...
class TestRespondExchangeRequest:
    ...
    def test_valid_request__strips_whitespace(self):
        ...
        request = RespondExchangeRequest(list_content="  Test List  ")
...
class TestCreateExchangeResponse:
    ...
    def test_valid_response__all_fields(self):
        ...
        assert (
            response.full_url
            == "https://squigleague.com/exchange/crimson-marine-charges-7a2f"
        )

    def test_invalid_response__missing_exchange_id(self):
        """Test that missing exchange_id is rejected"""
        with pytest.raises(ValidationError) as exc_info:
            CreateExchangeResponse(url="/test", full_url="https://test.com")
...
class TestHealthCheckResponse:
    ...
    def test_valid_response__all_fields(self):
        ...
        response = HealthCheckResponse(
            status="healthy", module="herald", database="connected"
        )
    ...
    def test_valid_response__unhealthy_status(self):
        ...
        response = HealthCheckResponse(
            status="unhealthy", module="herald", database="disconnected"
        )
...
class TestResourcesResponse:
    ...
    def test_valid_response__all_fields(self):
        ...
        response = ResourcesResponse(
            cpu_percent=45.5,
            memory={"used_mb": 2048.5, "available_mb": 6144.2, "percent": 25.0},
            disk={"used_gb": 50.5, "free_gb": 200.8, "percent": 20.0},
        )
    ...
    def test_invalid_response__missing_memory(self):
        ...
        with pytest.raises(ValidationError):
            ResourcesResponse(
                cpu_percent=50.0, disk={"used_gb": 10, "free_gb": 90, "percent": 10.0}
            )
