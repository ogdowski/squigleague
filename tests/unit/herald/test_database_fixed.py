...
class TestCreateExchange:
    ...
    def test_create_exchange__success(self, get_db_exchange, test_engine):
        ...
        # Verify in database
        result = test_engine.connect().execute(
...
class TestExchangeExists:
    ...
    def test_exchange_exists__returns_true_when_exists(self, get_db_exchange, test_engine):
    ...
    def test_exchange_exists__returns_false_when_not_exists(self, get_db_exchange, test_engine):
...
class TestGetExchange:
    ...
    def test_get_exchange__returns_none_when_not_found(self, get_db_exchange, test_engine):
        """Test that get_exchange returns None for non-existent exchange"""
        exchange = database.get_exchange("nonexistent-id")
        assert exchange is None
    
    def test_get_exchange__includes_list_b_when_complete(self, get_db_exchange, test_engine):
...
class TestUpdateExchangeWithListB:
    ...
    def test_update_exchange_with_list_b__only_updates_when_null(self, get_db_exchange, test_engine):
    ...
    def test_update_exchange_with_list_b__fails_for_nonexistent(self, get_db_exchange, test_engine):
...
class TestExchangeIsComplete:
    ...
    def test_exchange_is_complete__returns_true_when_complete(self, get_db_exchange, test_engine):
    ...
    def test_exchange_is_complete__returns_false_when_pending(self, get_db_exchange, test_engine):
    ...
    def test_exchange_is_complete__returns_false_for_nonexistent(self, get_db_exchange, test_engine):
...
class TestGetAbusiveIPs:
    ...
    def test_get_abusive_ips__returns_ips_over_threshold(self, get_db_exchange, test_engine):
    ...
    def test_get_abusive_ips__filters_by_time_window(self, get_db_exchange, test_engine):
...
class TestCheckDatabaseHealth:
    ...
    def test_check_database_health__returns_true_when_connected(self, get_db_exchange, test_engine):
