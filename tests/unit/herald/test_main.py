...
class TestMiddleware:
    ...
    def test_filter_bots__blocks_wget(self, test_client):
        ...
        response = test_client.get(
            "/api/herald/exchange/test", headers={"User-Agent": "wget/1.20.3"}
        )
    ...
    def test_filter_bots__blocks_scrapy(self, test_client):
        ...
        response = test_client.get(
            "/api/herald/exchange/test", headers={"User-Agent": "scrapy/2.5.0"}
        )
    ...
    def test_filter_bots__allows_health_endpoint_always(self, test_client):
        ...
        response = test_client.get("/health", headers={"User-Agent": "wget/1.20"})
...
class TestCreateExchange:
    ...
    def test_create_exchange__saves_to_database(self, test_client, test_engine):
        ...
        response = test_client.post(
            "/api/herald/exchange/create", json={"list_content": "Database Test List"}
        )
...
class TestGetExchange:
    ...
    def test_get_exchange__returns_pending_exchange(
        ...
        exchange_id = create_test_exchange(
            exchange_id="test-pending-001", list_a="Player A List", list_b=None
        )
    ...
    def test_get_exchange__returns_complete_exchange(
        self, test_client, create_test_exchange
    ):
...
class TestRespondExchange:
    ...
    def test_respond_exchange__completes_exchange(
        self, test_client, create_test_exchange
    ):
    ...
    def test_respond_exchange__404_for_invalid_id(self, test_client):
        ...
        response = test_client.post(
            "/api/herald/exchange/invalid-id/respond", json={"list_content": "Player B"}
        )
    ...
    def test_respond_exchange__400_when_already_complete(
        self, test_client, create_test_exchange
    ):
        """Test that respond returns 400 if exchange already complete"""
        exchange_id = create_test_exchange(list_a="Player A", list_b="Player B Already")
...
class TestCheckStatus:
    ...
    def test_check_status__returns_false_for_pending(
        self, test_client, create_test_exchange
    ):
    ...
    def test_check_status__returns_true_for_complete(
        self, test_client, create_test_exchange
    ):
...
class TestScheduler:
    ...
    def test_cleanup_old_data__calls_delete_functions(
        self, mock_delete_logs, mock_delete_exchanges
    ):
