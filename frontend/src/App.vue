    ...
    <div v-if="showFeedbackInfo" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50" @click.self="showFeedbackInfo = false">
      <div class="bg-gray-800 rounded-lg p-6 max-w-sm w-full mx-4">
        ...
        <div class="space-y-3">
          ...
          <a href="https://discord.com/users/198077137050271744" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 bg-gray-700 rounded px-4 py-3 hover:bg-gray-600 transition-colors">
