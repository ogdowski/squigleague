        ...
        <div class="max-w-6xl mx-auto px-4 py-12" x-data="matchupManager()">
            ...
            <div x-show="matchup?.is_complete && matchup?.battle_plan" class="space-y-6">
                ...
                <div class="bg-bg-darker rounded-lg shadow-xl p-8 border border-primary/30">
                    ...
                    <!-- Battle Plan Diagram -->
                    <div x-show="matchup?.battle_plan?.deployment_map_url" class="mb-6">
                        <img 
                            :src="matchup?.battle_plan?.deployment_map_url" 
                            :alt="'Battle plan diagram for ' + matchup?.battle_plan?.name"
                            class="w-full max-w-4xl mx-auto rounded-lg shadow-lg border border-bg-dark"
                        >
                    </div>
