...
MISSIONS = {
    ...
    "aos-roiling-roots": {
        "name": "Roiling Roots",
        "deployment_zones": [
            {"player": "Red Top", "color": "#dc3545", "alpha": 0.3, "coords": [(0, 33), (60, 33), (60, 44), (0, 44)]},
            {"player": "Blue Bottom", "color": "#007bff", "alpha": 0.3, "coords": [(0, 0), (60, 0), (60, 11), (0, 11)]},
            {"player": "Neutral", "color": "#666666", "alpha": 0.2, "coords": [(0, 11), (60, 11), (60, 33), (0, 33)]},
        ],
        "exclusion_zones": [],
        "objectives": [
            {"name": "Purple G3", "x": 37.5, "y": 38.5, "color": "purple", "type": "objective", "size": "large"},
            {"name": "Green G6", "x": 22.5, "y": 27.5, "color": "green", "type": "objective", "size": "large"},
            {"name": "Red G8", "x": 52.5, "y": 27.5, "color": "red", "type": "objective", "size": "large"},
            {"name": "Red G9", "x": 7.5, "y": 16.5, "color": "red", "type": "objective", "size": "large"},
            {"name": "Green G11", "x": 37.5, "y": 16.5, "color": "green", "type": "objective", "size": "large"},
            {"name": "Blue G14", "x": 22.5, "y": 5.5, "color": "blue", "type": "objective", "size": "large"},
        ],
        "terrain": [
            {"name": "Ruins G7", "x": 37.5, "y": 27.5, "type": "ruins", "size": "large"},
            {"name": "Ruins G10", "x": 22.5, "y": 16.5, "type": "ruins", "size": "large"},
            {"name": "PoP G4", "x": 52.5, "y": 36.5, "type": "place_of_power", "size": "small"},
            {"name": "PoP G13", "x": 7.5, "y": 7.5, "type": "place_of_power", "size": "small"},
            {"name": "Forest G1/G2", "x": 15, "y": 34.5, "type": "forest", "size": "large"},
            {"name": "Forest G15/G16", "x": 45, "y": 9.5, "type": "forest", "size": "large"},
            {"name": "Ruins G5", "x": 9.5, "y": 25.5, "type": "ruins", "size": "small"},
            {"name": "Ruins G12", "x": 50.5, "y": 18.5, "type": "ruins", "size": "small"},
        ]
    },
    "aos-surge-of-slaughter": {
        "name": "Surge of Slaughter",
        "deployment_zones": [
            {"player": "Red Top", "color": "#dc3545", "alpha": 0.3, "coords": [(0, 22), (60, 22), (60, 44), (0, 44)]},
            {"player": "Blue Bottom", "color": "#007bff", "alpha": 0.3, "coords": [(0, 0), (60, 0), (60, 22), (0, 22)]},
        ],
        "exclusion_zones": [
            {"type": "rect", "coords": [(0, 13), (60, 13), (60, 22), (0, 22)], "color": "#666666", "alpha": 0.15, "note": "9\" from blue edge"},
            {"type": "rect", "coords": [(0, 22), (60, 22), (60, 31), (0, 31)], "color": "#666666", "alpha": 0.15, "note": "9\" from red edge"},
        ],
        "objectives": [
            {"name": "Blue Center", "x": 30, "y": 22, "color": "blue", "type": "objective", "size": "large"},
            {"name": "Green G2", "x": 22.5, "y": 38.5, "color": "green", "type": "objective", "size": "large"},
            {"name": "Green G15", "x": 37.5, "y": 5.5, "color": "green", "type": "objective", "size": "large"},
            {"name": "Red G8", "x": 52.5, "y": 27.5, "color": "red", "type": "objective", "size": "large"},
            {"name": "Red G9", "x": 7.5, "y": 16.5, "color": "red", "type": "objective", "size": "large"},
        ],
        "terrain": [
            {"name": "Forest NW", "x": 13.5, "y": 34.5, "type": "forest", "size": "large"},
            {"name": "Forest SE", "x": 46.5, "y": 9.5, "type": "forest", "size": "large"},
            {"name": "Ruins G7", "x": 41.5, "y": 23.5, "type": "ruins", "size": "large"},
            {"name": "Ruins G10", "x": 18.5, "y": 20.5, "type": "ruins", "size": "large"},
            {"name": "PoP G3", "x": 31.5, "y": 33.5, "type": "place_of_power", "size": "small"},
            {"name": "PoP G14", "x": 28.5, "y": 10.5, "type": "place_of_power", "size": "small"},
            {"name": "Forest G3", "x": 43.5, "y": 34.5, "type": "forest", "size": "small"},
            {"name": "Forest G14", "x": 16.5, "y": 9.5, "type": "forest", "size": "small"},
        ]
    },
    "aos-the-liferoots": {
        "name": "The Liferoots",
        "deployment_zones": [
            {"player": "Red", "color": "#dc3545", "alpha": 0.3, "coords": [(0, 11), (30, 11), (30, 44), (0, 44)]},
            {"player": "Blue", "color": "#007bff", "alpha": 0.3, "coords": [(30, 0), (60, 0), (60, 33), (30, 33)]},
            {"player": "Neutral Top", "color": "#666666", "alpha": 0.15, "coords": [(30, 33), (60, 33), (60, 44), (30, 44)]},
            {"player": "Neutral Bottom", "color": "#666666", "alpha": 0.15, "coords": [(0, 0), (30, 0), (30, 11), (0, 11)]},
        ],
        "exclusion_zones": [
            {"player": "Red G6 Exclusion", "color": "#666666", "alpha": 0.15, "coords": [(21, 22), (30, 22), (30, 33), (21, 33)]},
            {"player": "Blue G7 Exclusion", "color": "#666666", "alpha": 0.15, "coords": [(30, 22), (39, 22), (39, 33), (30, 33)]},
            {"player": "Red G10 Exclusion", "color": "#666666", "alpha": 0.15, "coords": [(21, 11), (30, 11), (30, 22), (21, 22)]},
            {"player": "Blue G11 Exclusion", "color": "#666666", "alpha": 0.15, "coords": [(30, 11), (39, 11), (39, 22), (30, 22)]},
            {"type": "quarter_circle", "center": (30, 33), "radius": 9, "quadrant": "top_left", "color": "#666666", "alpha": 0.15, "note": "G2 quarter circle"},
            {"type": "quarter_circle", "center": (30, 11), "radius": 9, "quadrant": "bottom_right", "color": "#666666", "alpha": 0.15, "note": "G15 quarter circle"},
        ],
        "objectives": [
            {"name": "Green Obj", "x": 45, "y": 22, "color": "green", "type": "objective", "size": "large"},
            {"name": "Red Obj", "x": 15, "y": 22, "color": "red", "type": "objective", "size": "large"},
        ],
        "terrain": [
            {"name": "PoP G1", "x": 11.5, "y": 36.5, "type": "place_of_power", "size": "large"},
            {"name": "Forest G6", "x": 26.5, "y": 29.5, "type": "forest", "size": "large"},
            {"name": "PoP G16", "x": 48.5, "y": 7.5, "type": "place_of_power", "size": "large"},
            {"name": "Forest G11", "x": 33.5, "y": 14.5, "type": "forest", "size": "large"},
            {"name": "Forest G4", "x": 50.5, "y": 38.5, "type": "forest", "size": "small"},
            {"name": "Forest G3", "x": 41.5, "y": 33.5, "type": "forest", "size": "small"},
            {"name": "Forest G13", "x": 9.5, "y": 5.5, "type": "forest", "size": "small"},
            {"name": "Forest G14", "x": 18.5, "y": 10.5, "type": "forest", "size": "small"},
        ]
    },
}
